...
class _AddPageState extends State<AddPage> {
  ...
  DateTime.now(); // Store the selected date, default to today
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      // Use today's date as the default if no date is selected
      setState(() {
        selectedDate = picked;
      });
    }
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (name.isNotEmpty && amount != null) {
                final newExpense = Expense(name: name, category: selectedCategory, amount: amount,
                    currency: selectedCurrency, date: selectedDate, description: description);
